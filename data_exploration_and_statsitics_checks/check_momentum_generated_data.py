...
events = np.load("/work/submit/anton100/msci-project/FCC-BB-GenAI/new_25_before/generated_events.npy", allow_pickle=True)
...
plt.tight_layout()
plt.savefig("momentum_component_distributions_gen.png")
plt.show()