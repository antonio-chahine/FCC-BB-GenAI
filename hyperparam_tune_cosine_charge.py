...
import particle_diffusion_cosine_charge as pdm
from particle_diffusion_cosine_charge import (
...
def _compute_peak_score(cfg, ddpm, ds_full, val_idx, device, n_sample=200):
    ...
    try:
        from particle_diffusion_cosine_charge import sample_batch, extract_species
        meta_tmp = {
