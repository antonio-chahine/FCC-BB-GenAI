...
class CFG:
    ...
    T: int = 1000
    beta_start: float = 1.0592526792498264e-05
    beta_end: float = 0.049340486802611244

    d_model = 256
    nhead = 2
    num_layers = 3
    dropout = 0.177335434251012
    
    batch_size: int = 32
    lr: float = 0.0010232966843958737
    epochs: int = 50
    num_workers: int = 8
    grad_clip: float = 2.0301249143309064
    seed: int = 123
    ...
    feat_dim: int = 7
    n_pdg: int = 2
    lambda_pdg: float = 0.11025219374898987

    gamma_start: float = 0.0018803066900399006
    gamma_end: float = 0.14953038487527626

    n_events = 500
    sample_batch_size: int = 16

    pct_start: float = 0.13800147178256736
    div_factor: float = 11.094821108168011
