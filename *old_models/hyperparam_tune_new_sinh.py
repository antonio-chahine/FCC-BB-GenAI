...
from particle_diffusion_new import (
    CFG, MCPDataset, ParticleDenoiser, DDPM,
    make_linear_gamma_schedule, q_sample_pdg, q_sample_zplane,
    split_indices, set_seed,
)
    ...
    for epoch in range(cfg.epochs):
        ...
        try:
            for x0, pdg0, zplane0, mask in dl_train:
                ...
                loss        = diff_loss + cfg.lambda_pdg * pdg_loss + cfg.lambda_zplane * zplane_loss
